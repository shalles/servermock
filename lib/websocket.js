    ...
    wsServer.on('request', function(request) {
        ...
        connection.on('message', function(message) {
            if (message.type === 'utf8') {
                ...
                config.log && utils.log(message.utf8Data);
                        ...
                        for(var i in cliList){
                            ...
                            (meTome || sockCli !== connection) && (function(sockCli, data){
                                ...
                                sockCli.sendUTF(data, function() {
                                    ...
                                    utils.log(utils.chalk.green('[' + utils.chalk.yellow(dataFrom) + ' send a message to ' + utils.chalk.yellow(dataTo)+ ']'), config.log && data || '');
                                });
                            })(sockCli, data);
                        }
                    }
